    ...
    const lettersData = [
        {
            id: 1,
            name: "~ Aapka Billa",
            msg: "Wish you the happiest birthday malkin of my heart. May your day be filled with love, laughter, and all the things that make you smile. You deserve the world and more, and I hope this year brings you endless joy and unforgettable memories. Happy Birthday, my love!",
        },
        {
            id: 2,
            name: "~ Aapka Billa",
        ...
        },
        {
            id: 6,
            name: "~ Aapka Billa",
            msg: "The day you confessed your feelings.The day you said you were in love with me. It was a moment that changed everything, a moment that made me realize how deeply I felt for you. That was one of the happiest days of my life, a day I will always treasure, because it was the day my heart found its home in yours.",
        },
        {
            id: 7,
            name: "~ Aapka Billa",
                ...
                <div className={`envelope ${openEnvelope ? "active" : ""}`}>
                    ...
                    <div className="munna envelope-flap text-black relative">
                        <div className='munna absolute left-1/2 top-[20%] -translate-x-1/2 flex items-center justify-center flex-col md:gap-y-2'>
                            ...
                            <span className='munna font-dancingScript md:text-3xl text-xl'>Dear Zarin</span>
                        </div>
                    </div>
